...
NOTE:
The below import is for using Graphviz. Make sure you install it in your computer, after downloading it from here:
https://graphviz.gitlab.io/_pages/Download/Download_windows.html

You must install the package into python as well. To do that, run the following command into the Python console:
...
# =============================================================================
# The command below will export the graph into a PDF file located within the same folder as this script.
